<template>
	<div class="page-seckill">
        ...
        <el-dialog
            ...
            <div class="div-info">
                <span class="span-info">活动名称：</span>
                <span>{{seckillInfo.title}}</span>
            </div>
            <div class="div-info">
                <span class="span-info">活动时间：</span>
                <el-date-picker
                    v-model="dateVal"
                    value-format="timestamp"
                    type="datetimerange"
            ...
            <p class="div-info" style="margin-bottom: 10px">
                <span class="span-info">活动经理：</span>
                <span>高负责人</span>
            </p>
            <p class="div-info">
                <span class="span-info">咨询电话：</span>
                <span>18438622668</span>
            </p>
            <div slot="footer" class="dialog-footer" style="text-align: right">
                <el-button @click="seckillVisible = false">取 消</el-button>
                <el-button type="primary" @click="seckillVisible = false">确 定</el-button>
            </div>
        </el-dialog>
	</div>
</template>
...
export default {
	...
	methods: {
        onSeckill(e){
            this.seckillInfo = e;
            this.dateVal = [e.begintime,e.endtime]
...
<style>
.page-seckill .div-info{
    margin: 20px 0;
    font-size: 16px;
}
.page-seckill .span-info{
